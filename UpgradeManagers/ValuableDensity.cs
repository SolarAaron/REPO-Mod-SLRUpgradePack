                ...
                foreach (var pair in valuableDensityUpgrade.UpgradeRegister.PlayerDictionary) {
                    if (valuableDensityUpgrade.TotalMaxAmountCurves.Count != 0) {
                        ...
                        foreach (var element in GetNumberedFieldRefs<ValuableDirector, AnimationCurve>(ValuableDirector.instance, "totalMaxAmountCurve", 10)
                            ...
                            element.Item1.Item1.Invoke(ValuableDirector.instance) = ReplaceCurve(valuableDensityUpgrade.TotalMaxAmountCurves[element.Item2],
                                                                                                 value => valuableDensityUpgrade.Calculate(value, SemiFunc.PlayerGetFromSteamID(pair.Key), pair.Value));
                        }
                    } else {
                    ...
                    if (valuableDensityUpgrade.TotalMaxValueCurves.Count != 0) {
                        ...
                        foreach (var element in GetNumberedFieldRefs<ValuableDirector, AnimationCurve>(ValuableDirector.instance, "totalMaxValueCurve", 10)
                                               ...
                                               .Select((value, index) => Tuple.Create(value, index))
                                               .Where(value => value.Item1.Item1 != null && value.Item1.Item2 != null)) {
                            element.Item1.Item1.Invoke(ValuableDirector.instance) = ReplaceCurve(valuableDensityUpgrade.TotalMaxValueCurves[element.Item2],
                                                                                                 value => valuableDensityUpgrade.Calculate(value, SemiFunc.PlayerGetFromSteamID(pair.Key), pair.Value));
                        }
                    }
                    ...
                    foreach (var element in GetNumberedFieldRefs<ValuableDirector, AnimationCurve>(ValuableDirector.instance, "tinyMaxAmountCurve", 10)
                        ...
                        element.Item1.Item1.Invoke(ValuableDirector.instance) =
                            ReplaceCurve(valuableDensityUpgrade.TinyCurves[element.Item2], value => valuableDensityUpgrade.Calculate(value, SemiFunc.PlayerGetFromSteamID(pair.Key), pair.Value));
                    }
                    ...
                    foreach (var element in GetNumberedFieldRefs<ValuableDirector, AnimationCurve>(ValuableDirector.instance, "smallMaxAmountCurve", 10)
                                           ...
                                           .Where(value => value.Item1.Item1 != null && value.Item1.Item2 != null)) {
                        element.Item1.Item1.Invoke(ValuableDirector.instance) =
                            ReplaceCurve(valuableDensityUpgrade.SmallCurves[element.Item2], value => valuableDensityUpgrade.Calculate(value, SemiFunc.PlayerGetFromSteamID(pair.Key), pair.Value));
                    }
                    ...
                    foreach (var element in GetNumberedFieldRefs<ValuableDirector, AnimationCurve>(ValuableDirector.instance, "mediumMaxAmountCurve", 10)
                                           ...
                                           .Where(value => value.Item1.Item1 != null && value.Item1.Item2 != null)) {
                        element.Item1.Item1.Invoke(ValuableDirector.instance) =
                            ReplaceCurve(valuableDensityUpgrade.MediumCurves[element.Item2], value => valuableDensityUpgrade.Calculate(value, SemiFunc.PlayerGetFromSteamID(pair.Key), pair.Value));
                    }
                    ...
                    foreach (var element in GetNumberedFieldRefs<ValuableDirector, AnimationCurve>(ValuableDirector.instance, "bigMaxAmountCurve", 10)
                                           ...
                                           .Where(value => value.Item1.Item1 != null && value.Item1.Item2 != null)) {
                        element.Item1.Item1.Invoke(ValuableDirector.instance) =
                            ReplaceCurve(valuableDensityUpgrade.BigCurves[element.Item2], value => valuableDensityUpgrade.Calculate(value, SemiFunc.PlayerGetFromSteamID(pair.Key), pair.Value));
                    }
                    ...
                    foreach (var element in GetNumberedFieldRefs<ValuableDirector, AnimationCurve>(ValuableDirector.instance, "wideMaxAmountCurve", 10)
                                           ...
                                           .Where(value => value.Item1.Item1 != null && value.Item1.Item2 != null)) {
                        element.Item1.Item1.Invoke(ValuableDirector.instance) =
                            ReplaceCurve(valuableDensityUpgrade.WideCurves[element.Item2], value => valuableDensityUpgrade.Calculate(value, SemiFunc.PlayerGetFromSteamID(pair.Key), pair.Value));
                    }
                    ...
                    foreach (var element in GetNumberedFieldRefs<ValuableDirector, AnimationCurve>(ValuableDirector.instance, "tallMaxAmountCurve", 10)
                                           ...
                                           .Where(value => value.Item1.Item1 != null && value.Item1.Item2 != null)) {
                        element.Item1.Item1.Invoke(ValuableDirector.instance) =
                            ReplaceCurve(valuableDensityUpgrade.TallCurves[element.Item2], value => valuableDensityUpgrade.Calculate(value, SemiFunc.PlayerGetFromSteamID(pair.Key), pair.Value));
                    }
                    ...
                    foreach (var element in GetNumberedFieldRefs<ValuableDirector, AnimationCurve>(ValuableDirector.instance, "veryTallMaxAmountCurve", 10)
                                           ...
                                           .Where(value => value.Item1.Item1 != null && value.Item1.Item2 != null)) {
                        element.Item1.Item1.Invoke(ValuableDirector.instance) =
                            ReplaceCurve(valuableDensityUpgrade.VeryTallCurves[element.Item2], value => valuableDensityUpgrade.Calculate(value, SemiFunc.PlayerGetFromSteamID(pair.Key), pair.Value));
                    }
                }
