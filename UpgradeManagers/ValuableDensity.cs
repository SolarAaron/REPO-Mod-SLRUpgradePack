    ...
    private static void Prefix(LevelGenerator __instance)
    {
        ...
        if (SemiFunc.IsMasterClientOrSingleplayer() && valuableDensityUpgrade.UpgradeEnabled.Value)
        {
            ...
            if (!initialized)
            {
                ...
                valuableDensityUpgrade.SmallCurves =
                    GetNumberedFieldRefs<ValuableDirector, AnimationCurve>(ValuableDirector.instance,
                        "smallMaxAmountCurve", 10).Select(re => re.Invoke(ValuableDirector.instance)).ToList();
                valuableDensityUpgrade.MediumCurves =
                    GetNumberedFieldRefs<ValuableDirector, AnimationCurve>(ValuableDirector.instance,
                        "mediumMaxAmountCurve", 10).Select(re => re.Invoke(ValuableDirector.instance)).ToList();
                valuableDensityUpgrade.BigCurves =
                    GetNumberedFieldRefs<ValuableDirector, AnimationCurve>(ValuableDirector.instance,
                        "bigMaxAmountCurve", 10).Select(re => re.Invoke(ValuableDirector.instance)).ToList();
                valuableDensityUpgrade.WideCurves =
                    GetNumberedFieldRefs<ValuableDirector, AnimationCurve>(ValuableDirector.instance,
                        "wideMaxAmountCurve", 10).Select(re => re.Invoke(ValuableDirector.instance)).ToList();
                valuableDensityUpgrade.TallCurves =
                    GetNumberedFieldRefs<ValuableDirector, AnimationCurve>(ValuableDirector.instance,
                        "tallMaxAmountCurve", 10).Select(re => re.Invoke(ValuableDirector.instance)).ToList();
                valuableDensityUpgrade.VeryTallCurves =
                    GetNumberedFieldRefs<ValuableDirector, AnimationCurve>(ValuableDirector.instance,
                        "veryTallMaxAmountCurve", 10).Select(re => re.Invoke(ValuableDirector.instance)).ToList();
                valuableDensityUpgrade.TotalMaxAmountCurves =
                    GetNumberedFieldRefs<ValuableDirector, AnimationCurve>(ValuableDirector.instance,
                        "totalMaxAmountCurve", 10).Select(re => re.Invoke(ValuableDirector.instance)).ToList();
                ;
                valuableDensityUpgrade.TotalMaxValueCurves =
                    GetNumberedFieldRefs<ValuableDirector, AnimationCurve>(ValuableDirector.instance,
                        "totalMaxValueCurve", 10).Select(re => re.Invoke(ValuableDirector.instance)).ToList();
                ;
                initialized = true;
            }

            var numberedMethodDelegates =
                GetStaticNumberedMethodDelegates<difficultyDelegate>(typeof(SemiFunc), "RunGetDifficultyMultiplier", [],
                    10);
